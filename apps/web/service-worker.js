'use strict';
const SHELL = 'qiyu-shell-v3';
const ASSETS = ['/', '/app.js', '/encrypted-session.js', '/styles.css', '/prototype-restoration.css', '/tokens.css', '/favicon.svg', '/assets/player-play-filled.svg', '/assets/player-pause-filled.svg'];
