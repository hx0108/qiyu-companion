...
|---|---|---|---|---|
| SEM-01 | 口渴的时候你会给我泡点什么 | ras_rain_tea | ras_rain_tea, ras_bookstore_meet, ras_current_city | PASS |
| SEM-02 | 我们说好到时候在哪儿碰头 | ras_bookstore_meet | ras_bookstore_meet, ras_current_city, ras_rain_tea | PASS |
| SEM-03 | 我如今的落脚点在哪座城市 | ras_current_city | ras_current_city, ras_bookstore_meet, ras_rain_tea | PASS |
